; edited by X. Feng
; For background subtraction, this script assumes the movie begins with 10 frames of 3rd channel excitation (for ex. Cy7) and 10 frames of 2nd channel excitation (Cy5), ends with 10 frames of 3rd channel excitation and 10 frames of 2nd channel excitation. For the rest of the frames in between, the fluorophore for the 1st channel should be exicted in the rest (Cy3)
  ...
  openr, 2, run + ".3color_3alex_pks"
	...
	for t = 0, film_time_length - 1 do begin
		...
		for j = 0, NumberofGoodLocations - 1 do begin
			if ((t GE 20) and (t LT film_time_length - 20)) then begin
			...
			if ((t LT 10) or ((t GE film_time_length - 20) and (t LT film_time_length - 10))) then begin
			...
			if (((t GE 10) and (t LT 20)) or (t GT film_time_length - 10)) then begin
